...
@objc public enum iTunesEVdK : AEKeyword {
    /* not a video or unknown video kind */
    case None = 0x6b4e6f6e /* 'kNon' */
    /* home video track */
    case HomeVideo = 0x6b566448 /* 'kVdH' */
    /* movie track */
...
@objc public protocol iTunesGenericMethods {
    @objc optional func printPrintDialog(_ printDialog: Bool, withProperties: NSDictionary, kind: iTunesEKnd, theme: String) // Print the specified object(s)
    @objc optional func close() // Close an object
    @objc optional func delete() // Delete an element from an object
    @objc optional func duplicateTo(_ to: SBObject) // Duplicate one or more object(s)
...
@objc public protocol iTunesItem: SBObjectProtocol, iTunesGenericMethods {
    ...
    @objc optional var properties: NSDictionary { get } // every property of the item
    ...
    @objc optional func setProperties(_ properties: NSDictionary) // every property of the item
}
...
@objc public protocol iTunesPlaylist: iTunesItem {
    ...
    @objc optional func setShuffle(_ shuffle: Bool)
